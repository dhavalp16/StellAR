...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.ARStarterAssets
{
    ...
    public class ARSampleMenuManager : MonoBehaviour
    {
        ...
        void PopulateDynamicMenu()
        {
            ...
            if (!System.IO.Directory.Exists(modelsPath)) return;
            ...
            foreach (var file in files)
            {
                ...
                btn.onClick.AddListener(() => SetDynamicObject(localPath));
            }
        }
        ...
        void SetDynamicObject(string path)
        {
             ...
             {
                 Debug.LogWarning("DynamicModelLoader instance not found!");
                 return;
             }
             ...
             {
                 Debug.LogWarning("Dynamic Placeholder Prefab not assigned in ARSampleMenuManager!");
             }
        }
    }
}
